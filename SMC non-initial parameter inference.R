...
plot(rowMeans(exp(theta.1[,1,])),ylim=c(0,100),type='l',col=1,main = 'R0',xlab = 'Iteraion times',ylab = 'Iterated R0')
lines(sapply(1:MM,function(mm) median(exp(theta.1[mm,1,]))),col=2,lty=1)
lines(sapply(1:MM,function(mm) quantile(exp(theta.1[mm,1,]),0.1)),col=3,lty=2)
lines(sapply(1:MM,function(mm) quantile(exp(theta.1[mm,1,]),0.9)),col=3,lty=2)
legend("topright", bty="n",legend=c("Est. R0:mean","Est. median",'Est. 10%,90% quantile'),col=c(1,2,3), lty=c(1,1,2), cex=0.7)

plot(rowMeans(-1/(2*(1-p))+logit(theta.2[,1,])*1/(2*p)-(-1/(2*(1-p)))),ylim=c(0.05,0.75),type='l',col=1,main = 'a',xlab = 'Iteraion times',ylab = 'Iterated a')
lines(sapply(1:MM,function(mm) median(-1/(2*(1-p))+logit(theta.2[mm,1,])*1/(2*p)-(-1/(2*(1-p))))),col=2,lty=1)
lines(sapply(1:MM,function(mm) quantile(-1/(2*(1-p))+logit(theta.2[mm,1,])*1/(2*p)-(-1/(2*(1-p))),0.1)),col=3,lty=2)
lines(sapply(1:MM,function(mm) quantile(-1/(2*(1-p))+logit(theta.2[mm,1,])*1/(2*p)-(-1/(2*(1-p))),0.9)),col=3,lty=2)
legend("topright", bty ="n",legend=c("Est. a:mean","Est. median",'Est. 10%,90% quantile'),col=c(1,2,3), lty=c(1,1,2), cex=0.7)

plot(rowMeans(exp(theta.3[,1,])),ylim=c(200,1200),type='l',col=1,main = 'G',xlab = 'Iteraion times',ylab = 'Iterated G')
lines(sapply(1:MM,function(mm) median(exp(theta.3[mm,1,]),0.1)),col=2,lty=1)
lines(sapply(1:MM,function(mm) quantile(exp(theta.3[mm,1,]),0.1)),col=3,lty=2)
lines(sapply(1:MM,function(mm) quantile(exp(theta.3[mm,1,]),0.9)),col=3,lty=2)
legend("topright", bty ="n",legend=c("Est. G:mean","Est. median",'Est. 10%,90% quantile'),col=c(1,2,3), lty=c(1,1,2), cex=0.7)

plot(rowMeans(exp(theta.4[,1,])),ylim=c(0,7),type='l',col=1,main = 'alpha',xlab = 'Iteraion times',ylab = 'Iterated alpha')
lines(sapply(1:MM,function(mm) median(exp(theta.4[mm,1,]),0.1)),col=2,lty=1)
lines(sapply(1:MM,function(mm) quantile(exp(theta.4[mm,1,]),0.1)),col=3,lty=2)
lines(sapply(1:MM,function(mm) quantile(exp(theta.4[mm,1,]),0.9)),col=3,lty=2)
legend("topright", bty ="n",legend=c("Est. alpha:mean","Est. median",'Est. 10%,90% quantile'),col=c(1,2,3), lty=c(1,1,2), cex=0.7)

plot(rowMeans(1/(exp(theta.5[,1,]) * (1-logit(theta.6[,1,])))),ylim=c(0.2,4),type='l',col=1,main = 'v.ei',xlab = 'Iteraion times',ylab = 'Iterated v.ei')
lines(sapply(1:MM,function(mm) median(1/(exp(theta.5[mm,1,]) * (1-logit(theta.6[mm,1,]))))),col=2,lty=1)
lines(sapply(1:MM,function(mm) quantile(1/(exp(theta.5[mm,1,]) * (1-logit(theta.6[mm,1,]))),0.1)),col=3,lty=2)
lines(sapply(1:MM,function(mm) quantile(1/(exp(theta.5[mm,1,]) * (1-logit(theta.6[mm,1,]))),0.9)),col=3,lty=2)
legend("topright", bty ="n",legend=c("Est. v.ei:mean","Est. median",'Est. 10%,90% quantile'),col=c(1,2,3), lty=c(1,1,2), cex=0.7)

plot(rowMeans(1/(exp(theta.5[,1,]) * (logit(theta.6[,1,])))),ylim=c(0.2,4.2),type='l',col=1,main = 'v.ir',xlab = 'Iteraion times',ylab = 'Iterated v.ir')
lines(sapply(1:MM,function(mm) median(1/(exp(theta.5[mm,1,]) * (logit(theta.6[mm,1,]))))),col=2,lty=1)
lines(sapply(1:MM,function(mm) quantile(1/(exp(theta.5[mm,1,]) * (logit(theta.6[mm,1,]))),0.1)),col=3,lty=2)
lines(sapply(1:MM,function(mm) quantile(1/(exp(theta.5[mm,1,]) * (logit(theta.6[mm,1,]))),0.9)),col=3,lty=2)
legend("topright", bty ="n",legend=c("Est. v.ir:mean","Est. median",'Est. 10%,90% quantile'),col=c(1,2,3), lty=c(1,1,2), cex=0.7)

plot(rowMeans(logit(theta.7[,1,])),ylim=c(0,0.01),type='l',col=1,main = 'mu',xlab = 'Iteraion times',ylab = 'Iterated mu')
lines(sapply(1:MM,function(mm) median(logit(theta.7[mm,1,]))),col=2,lty=1)
lines(sapply(1:MM,function(mm) quantile(logit(theta.7[mm,1,]),0.1)),col=3,lty=2)
lines(sapply(1:MM,function(mm) quantile(logit(theta.7[mm,1,]),0.9)),col=3,lty=2)
legend("topright", bty ="n",legend=c("Est. mu:mean","Est. median",'Est. 10%,90% quantile'),col=c(1,2,3), lty=c(1,1,2), cex=0.7)

plot(rowMeans(logit(theta.8[,1,])),ylim=c(0,1),type='l',col=1,main = 'rho',xlab = 'Iteraion times',ylab = 'Iterated rho')
lines(sapply(1:MM,function(mm) median(logit(theta.8[mm,1,]))),col=2,lty=1)
lines(sapply(1:MM,function(mm) quantile(logit(theta.8[mm,1,]),0.1)),col=3,lty=2)
lines(sapply(1:MM,function(mm) quantile(logit(theta.8[mm,1,]),0.9)),col=3,lty=2)
legend("topright", bty ="n",legend=c("Est. rho:mean","Est. median",'Est. 10%,90% quantile'),col=c(1,2,3), lty=c(1,1,2), cex=0.7)

plot(rowMeans(exp(theta.9[,1,])),ylim=c(0,2),type='l',col=1,main = 'psi',xlab = 'Iteraion times',ylab = 'Iterated psi')
lines(sapply(1:MM,function(mm) median(exp(theta.9[mm,1,]))),col=2,lty=1)
lines(sapply(1:MM,function(mm) quantile(exp(theta.9[mm,1,]),0.1)),col=3,lty=2)
lines(sapply(1:MM,function(mm) quantile(exp(theta.9[mm,1,]),0.9)),col=3,lty=2)
